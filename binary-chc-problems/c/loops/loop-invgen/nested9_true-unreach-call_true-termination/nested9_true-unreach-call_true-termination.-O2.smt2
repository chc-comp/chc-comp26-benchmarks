...
(declare-fun |p$main_4196032::26!slice!5| ( (_ BitVec 64) (_ BitVec 64) (_ BitVec 32) (_ BitVec 64) (_ BitVec 64) (_ BitVec 64) ) Bool)
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) (E (_ BitVec 64)) (F (_ BitVec 64)) (G (_ BitVec 64)) ) 
    (=>
      ...
      (|p$main_4196032::26!slice!5| B F A G E D)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) (E (_ BitVec 64)) (v_5 (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196032::35!slice!3| D A E C B)
        (and (bvsle (bvadd ((_ extract 31 0) D) ((_ extract 31 0) E))
            ((_ extract 31 0) E))
     (= #x0000000000000000 v_5))
      )
      (|p$main_4196032::26!slice!5| v_5 D A E C B)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) (E (_ BitVec 64)) (F (_ BitVec 64)) (G (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196032::26!slice!5| C F A G E D)
        (let ((a!1 (= B (concat #x00000000 (bvadd #x00000001 ((_ extract 31 0) F))))))
  (and (not (= ((_ extract 31 0) B) ((_ extract 31 0) E))) a!1))
      )
      (|p$main_4196032::35!slice!3| B A G E D)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) (E (_ BitVec 64)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 64)) (I (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196032::26!slice!5| C F A G E D)
        (let ((a!1 (= H (concat #x00000000 (bvadd #x00000001 ((_ extract 31 0) G)))))
      (a!2 (= I (concat #x00000000 (bvadd #x00000002 ((_ extract 31 0) E)))))
      (a!3 (= B (concat #x00000000 (bvadd #x00000001 ((_ extract 31 0) F))))))
  (and (= ((_ extract 31 0) B) ((_ extract 31 0) E))
       a!1
       a!2
       a!3
       (not (= ((_ extract 31 0) D) ((_ extract 31 0) H)))))
      )
      (|p$main_4196032::39!slice!4| C A H I D)
    )
  )
)
(assert
