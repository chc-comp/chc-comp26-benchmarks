...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196572::29!slice!1| C G B E A D)
        (= F (bvadd #x00000001 B))
      )
      (|p$main_4196572::34!slice!2| G F E A D)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 64)) (v_4 (_ BitVec 32)) (v_5 (_ BitVec 32)) ) 
    (=>
      (and
        (let ((a!1 (bvsle (bvadd (concat ((_ extract 30 0) A) #b0) A) (bvadd C B))))
  (and a!1
      ...
      (|p$main_4196572::38!slice!3| D A v_4 v_5)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196572::29!slice!1| C F B E A D)
        (= ((_ extract 7 0) C) #x00)
      )
      false
    )
