...
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 32)) (D (_ BitVec 64)) (E (_ BitVec 64)) (F (_ BitVec 64)) (v_6 (_ BitVec 64)) ) 
    (=>
      (and
     ...
     (= #x0000000000400950 v_6))
      ...
      ($ENTER$__p$hanoi_4196572 F E v_6 D B)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 32)) (D (_ BitVec 64)) (E (_ BitVec 64)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 64)) (v_8 (_ BitVec 64)) ) 
    (=>
      (and
        (|p$hanoi_4196572::31| E G F v_8 D B H)
        (and (= #x0000000000400950 v_8)
     (not (bvsle C #x00000000))
     (not (bvsle C ((_ extract 31 0) G)))
     (= F (bvadd #xffffffffffffffe0 A))
