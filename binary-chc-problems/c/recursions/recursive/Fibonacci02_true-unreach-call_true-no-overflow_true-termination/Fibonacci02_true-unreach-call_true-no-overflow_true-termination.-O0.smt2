...
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) (E (_ BitVec 64)) (v_5 (_ BitVec 64)) (v_6 (_ BitVec 64)) ) 
    (=>
     ...
     (= #x0000000000000009 v_5)
     (= #x0000000000400958 v_6))
      )
      (|p$fibonacci_4196572::3| v_5 E B v_6 A C)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) (E (_ BitVec 64)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 64)) (I (_ BitVec 64)) (v_9 (_ BitVec 64)) (v_10 (_ BitVec 64)) ) 
    (=>
      (and
        (|p$fibonacci_4196572::46| v_9 A F D C B v_10 G H E)
        (and (= #x0000000000000009 v_9)
     (= #x0000000000400958 v_10)
     (= G (bvadd #xffffffffffffffe0 I))
     (not (= ((_ extract 31 0) A) #x00000022))
