...
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 64)) (I (_ BitVec 64)) (v_9 (_ BitVec 64)) ) 
    (=>
      (and
     ...
     (= #x00000000004009c0 v_9))
      ...
      (|p$ackermann_4196572::0| I C H G v_9 F A)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 64)) (I (_ BitVec 64)) (J (_ BitVec 64)) (K (_ BitVec 64)) (L (_ BitVec 64)) (M (_ BitVec 64)) (N (_ BitVec 64)) (v_14 (_ BitVec 64)) ) 
    (=>
      (and
        (|p$ackermann_4196572::55| F G C N J H K M v_14 L A I)
        (and (= #x00000000004009c0 v_14)
     (bvsle #x00000000 D)
     (bvsle ((_ extract 31 0) G) #x00000003)
     (bvsle E #x00000017)
     (bvsle D #x00000003)
