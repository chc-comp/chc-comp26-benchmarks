...
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) (E (_ BitVec 64)) (F (_ BitVec 64)) (G (_ BitVec 32)) (H (_ BitVec 32)) (I (_ BitVec 64)) (v_9 (_ BitVec 64)) ) 
    (=>
      (and
     ...
     (= #x0000000000400950 v_9))
      )
      ($ENTER$__p$sum_4196572 D C B F v_9 A E)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) (E (_ BitVec 64)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 64)) (I (_ BitVec 64)) (J (_ BitVec 64)) (K (_ BitVec 64)) (L (_ BitVec 32)) (M (_ BitVec 32)) (v_13 (_ BitVec 64)) ) 
    (=>
      (and
        (|p$sum_4196572::39| D B G E H C I v_13 A F J)
        (and (= #x0000000000400950 v_13)
     (= D (concat #x00000000 M))
     (= H (bvadd #xffffffffffffffe0 K))
     (= G (concat #x00000000 L))
     (not (= ((_ extract 31 0) B) (bvadd M L)))
