  ...
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (v_3 (_ BitVec 64)) ) 
    (=>
      (and
        ...
        (and (not (bvsle B C)) (bvsle A #x00000001) (= #x0000000000000000 v_3))
      )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (v_3 (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196572::28!slice!2| C A B)
        (and (bvsle B C) (bvsle A #x00000001) (= #x0000000000000001 v_3))
      )
      (|p$main_4196572::23!slice!4| v_3 C A B)
    )
  )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 64)) (F (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196572::23!slice!4| E D A B)
        (and (not (bvsle C #x00000001))
     (= C (bvadd #xffffffff B))
     (= F (concat ((_ extract 30 0) A) #b0)))
      )
      (|p$main_4196572::34!slice!3| F D A C)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) ) 
    (=>
     ...
     (not (bvsle A #x00000001)))
      ...
      (|p$main_4196572::34!slice!3| E C D B)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196572::23!slice!4| D C A B)
        (= ((_ extract 7 0) D) #x00)
      )
      false
    )
