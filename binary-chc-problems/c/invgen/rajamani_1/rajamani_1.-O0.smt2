  ...
  (forall ( (v_0 (_ BitVec 32)) (v_1 (_ BitVec 32)) (v_2 (_ BitVec 32)) (v_3 (_ BitVec 32)) ) 
    (=>
     ...
     (= #x00000000 v_3))
      ...
      (|p$main_4196572::29!slice!1| v_0 v_1 v_2 v_3)
    )
  )
)
(assert
    ...
    (=>
      (and
        ...
        (let ((a!1 (concat (bvadd (concat ((_ extract 28 0) D) #b00)
                          ((_ extract 30 0) D))
                   #b0)))
  (and (bvsle C a!1) (not (= E #x00000000))))
      )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196572::29!slice!1| B D A C)
        (and (bvsle A #x00000003) (not (= E #x00000000)) (not (= F #x00000000)))
      )
      (|p$main_4196572::13!slice!2| B D A C)
    )
  )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196572::13!slice!2| C E A D)
        (and (= B (bvadd #x00000001 E)) (= F (bvadd #x0000000a C)))
      )
      (|p$main_4196572::29!slice!1| F B A D)
    )
  )
)
(assert
  ...
  (and (bvsle (bvmul #x00000064 A) B)
      ...
      (|p$main_4196572::13!slice!2| B D A F)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196572::29!slice!1| B D A C)
        (and (= H (bvadd #x00000001 A))
     (not (= F #x00000000))
     (not (= E #x00000000))
     (= G (bvadd #x00000064 C)))
      )
      (|p$main_4196572::13!slice!2| B D H G)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) ) 
    (=>
     ...
     (= H (bvadd #x00000001 C)))
      ...
      (|p$main_4196572::13!slice!2| B D G H)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196572::29!slice!1| B D A C)
        (and (not (bvsle A #x00000003)) (bvsle C #x00000002))
      )
      false
    )
  )
