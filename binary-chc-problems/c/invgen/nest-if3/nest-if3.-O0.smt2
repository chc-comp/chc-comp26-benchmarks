...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (v_5 (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196572::31!slice!1| B D A C)
        (and (not (bvsle D E)) (= E (bvadd #x00000001 C)) (bvsle D A) (= v_5 B))
      )
      (|p$main_4196572::31!slice!1| B D v_5 E)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (v_7 (_ BitVec 32)) ) 
    (=>
     ...
     (= v_7 F))
      ...
      (|p$main_4196572::31!slice!1| F D v_7 G)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196572::22!slice!2| F C E B D)
        (= A (bvadd #x00000001 B))
      )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196572::22!slice!2| E B D A C)
        (= ((_ extract 7 0) E) #x00)
      )
      false
    )
