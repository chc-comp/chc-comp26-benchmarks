...
(declare-fun |p$main_4196032::22!slice!1| ( (_ BitVec 64) ) Bool)

(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 32)) ) 
    (=>
      (and
        (and (not (bvsle ((_ extract 31 0) A) #x00000000)) (= A (concat #x00000000 B)))
      )
      (|p$main_4196032::22!slice!1| A)
    )
  )
)
(assert
