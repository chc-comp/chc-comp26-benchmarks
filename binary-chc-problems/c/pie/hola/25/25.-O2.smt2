...
(declare-fun |p$main_4196032::20!slice!3| ( (_ BitVec 64) (_ BitVec 64) (_ BitVec 64) (_ BitVec 64) ) Bool)
...
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196032::28!slice!2| D A B C)
        true
      )
      (|p$main_4196032::23!slice!1| D A B C)
    )
  )
)
(assert
...
(assert
  ...
  (and (not (= ((_ extract 31 0) B) ((_ extract 31 0) C)))
      ...
      (|p$main_4196032::26!slice!4| E B C D)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) (E (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196032::20!slice!3| C A B D)
        (not (= E #x00000000))
      )
      (|p$main_4196032::28!slice!2| C A B D)
    )
  )
)
(assert
...
(assert
  ...
  (and (= ((_ extract 31 0) B) ((_ extract 31 0) C)) a!1))
      ...
      (|p$main_4196032::28!slice!2| A B C E)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 64)) (C (_ BitVec 64)) (D (_ BitVec 64)) (E (_ BitVec 64)) (F (_ BitVec 64)) ) 
    (=>
      (and
        (|p$main_4196032::23!slice!1| C A D E)
  ...
  (and (not (bvsle ((_ extract 31 0) C) ((_ extract 31 0) E)))
      ...
      (|p$main_4196032::20!slice!3| C F B E)
    )
  )
)
(assert
  ...
  (and (bvsle ((_ extract 31 0) C) ((_ extract 31 0) E)) a!1 a!2))
      )
      (|p$main_4196032::20!slice!3| C F B E)
    )
  )
