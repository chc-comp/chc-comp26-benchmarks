...
(assert
  (forall ( (A (_ BitVec 32)) (v_1 (_ BitVec 32)) (v_2 (_ BitVec 32)) ) 
    (=>
      (and
        (and (bvsle #x00000000 A) (= #x00000000 v_1) (= #x00000000 v_2))
      )
      (|p$main_4196572::20!slice!1| A v_1 v_2)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) ) 
    (=>
      (and
        ...
        (and (not (bvsle B A)) (= D (bvadd C A)) (= E (bvadd #x00000001 A)))
      )
      (|p$main_4196572::20!slice!1| B E D)
    )
  )
)
(assert
