  ...
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) (I (_ BitVec 32)) (J (_ BitVec 32)) ) 
    (=>
     ...
     (= I (bvadd #x00000001 G)))
      ...
      (|p$main_4196572::38!slice!1| D F J I H C E)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) (I (_ BitVec 32)) (J (_ BitVec 32)) (K (_ BitVec 32)) (L (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196572::38!slice!1| D F A G H C E)
        (and (= K (bvadd #x00000001 H))
     (not (= I #x00000000))
     (= J (bvadd #xffffffff F))
     (= L (bvadd #x00000001 A))
     (not (= B #x00000000)))
      )
      (|p$main_4196572::38!slice!1| D J L G K C E)
    )
  )
)
(assert
  ...
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) (I (_ BitVec 32)) (J (_ BitVec 32)) (K (_ BitVec 32)) (L (_ BitVec 32)) ) 
    (=>
     ...
     (not (= B #x00000000)))
      ...
      (|p$main_4196572::38!slice!1| K F A J H C L)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 32)) (H (_ BitVec 32)) (I (_ BitVec 32)) (J (_ BitVec 32)) (K (_ BitVec 32)) (L (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196572::38!slice!1| D F A G H C E)
        (and (= K (bvadd #xffffffff H))
     (not (= I #x00000000))
     (= J (bvadd #x00000001 E))
     (= L (bvadd #xffffffff C))
     (not (= B #x00000000)))
      )
      (|p$main_4196572::38!slice!1| D F A G K L J)
    )
  )
)
(assert
