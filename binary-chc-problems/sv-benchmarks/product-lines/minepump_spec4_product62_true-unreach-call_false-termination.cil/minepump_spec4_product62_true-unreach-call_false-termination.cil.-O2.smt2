...
(declare-fun |p$test_4197024::18!slice!1| ( (_ BitVec 64) (_ BitVec 64) (_ BitVec 64) (_ BitVec 64) (_ BitVec 32) (_ BitVec 32) (_ BitVec 32) (_ BitVec 32) ) Bool)
(declare-fun |p$test_4197024::15!slice!3| ( (_ BitVec 64) (_ BitVec 64) (_ BitVec 64) (_ BitVec 32) (_ BitVec 32) (_ BitVec 32) (_ BitVec 32) ) Bool)
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 64)) (v_8 (_ BitVec 64)) ) 
    (=>
      (and
        (|p$test_4197024::9!slice!2| C F G B D A E)
        (and (= H (bvadd #xfffffffffffffff0 G)) (= #x0000000000400b10 v_8))
      )
      (|p$timeShift_4196876::0| C F v_8 H D E B A)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 32)) (I (_ BitVec 64)) (v_9 (_ BitVec 64)) (v_10 (_ BitVec 32)) ) 
    (=>
      (and
        (|p$test_4197024::9!slice!2| C F G B D A E)
        (and (= I (bvadd #xfffffffffffffff0 G))
     (not (= H #x00000000))
     (= #x0000000000400b04 v_9)
     (= #x00000001 v_10))
      )
      (|p$timeShift_4196876::0| C F v_9 I v_10 E B A)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 64)) ) 
    (=>
      (and
        (|p$test_4197024::18!slice!1| F C G H B D A E)
        true
      )
      (|p$test_4197024::15!slice!3| C G H B D A E)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 32)) (I (_ BitVec 32)) (J (_ BitVec 64)) (K (_ BitVec 64)) (L (_ BitVec 32)) (M (_ BitVec 64)) (N (_ BitVec 64)) (O (_ BitVec 64)) (v_15 (_ BitVec 64)) (v_16 (_ BitVec 32)) (v_17 (_ BitVec 32)) ) 
    (=>
      (and
        (|p$timeShift_4196876::12| K M N C O F v_15 J I v_16 L E B A)
        (|p$test_4197024::9!slice!2| C F G B D A E)
        (and (= #x0000000000400b04 v_15)
     (= #x00000001 v_16)
     (= J (bvadd #xfffffffffffffff0 G))
     (not (= H #x00000000))
     (= #x00000001 v_17))
      )
      (|p$test_4197024::18!slice!1| M N O G I v_17 L E)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 64)) (G (_ BitVec 64)) (H (_ BitVec 32)) (I (_ BitVec 64)) (J (_ BitVec 64)) (K (_ BitVec 32)) (L (_ BitVec 64)) (M (_ BitVec 64)) (N (_ BitVec 64)) (v_14 (_ BitVec 64)) ) 
    (=>
      (and
        (|p$timeShift_4196876::12| J L M C N F v_14 I H D K E B A)
        (|p$test_4197024::9!slice!2| C F G B D A E)
        (and (= #x0000000000400b10 v_14) (= I (bvadd #xfffffffffffffff0 G)))
      )
      (|p$test_4197024::18!slice!1| L M N G H D K E)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 64)) (G (_ BitVec 64)) ) 
    (=>
      (and
        (|p$test_4197024::15!slice!3| C F G B D A E)
        true
      )
      (|p$test_4197024::9!slice!2| C F G B D A E)
    )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 64)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 64)) (H (_ BitVec 64)) (v_8 (_ BitVec 32)) ) 
    (=>
      (and
        (|p$test_4197024::15!slice!3| D G H C E A F)
        (and (not (= B #x00000000)) (not (= F #x00000000)) (= #x00000000 v_8))
      )
      (|p$test_4197024::9!slice!2| D G H C E A v_8)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 64)) (E (_ BitVec 32)) (F (_ BitVec 64)) (G (_ BitVec 64)) (v_7 (_ BitVec 32)) (v_8 (_ BitVec 32)) ) 
    (=>
      (and
        (|p$test_4197024::15!slice!3| D F G C E A v_7)
        (and (= #x00000000 v_7) (not (= B #x00000000)) (= #x00000001 v_8))
      )
      (|p$test_4197024::9!slice!2| D F G C E A v_8)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 64)) (H (_ BitVec 64)) (I (_ BitVec 64)) ) 
    (=>
      (and
        (|p$test_4197024::18!slice!1| G C H I B D A F)
        (and (not (bvsle B #x00000001)) (not (= E #x00000000)))
      )
      (|p$test_4197024::15!slice!3| C H I B D A F)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 64)) (B (_ BitVec 32)) (C (_ BitVec 32)) (D (_ BitVec 64)) (E (_ BitVec 64)) (F (_ BitVec 64)) (G (_ BitVec 64)) (v_7 (_ BitVec 32)) (v_8 (_ BitVec 32)) ) 
    (=>
     ...
     (= #x00000000 v_8))
      ...
      (|p$test_4197024::18!slice!1| A G D F B C v_7 v_8)
    )
  )
)
(assert
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 64)) (D (_ BitVec 32)) (E (_ BitVec 32)) (F (_ BitVec 32)) (G (_ BitVec 64)) (H (_ BitVec 64)) (I (_ BitVec 64)) (J (_ BitVec 32)) ) 
    (=>
      (and
        (|p$test_4197024::18!slice!1| G C H I B D A F)
        (and (bvsle B #x00000001) (not (= E #x00000000)) (= J (bvadd #x00000001 B)))
      )
      (|p$test_4197024::15!slice!3| C H I J D A F)
    )
  )
)
(assert
