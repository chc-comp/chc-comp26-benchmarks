...
(assert
  (forall ( (v_0 (_ BitVec 32)) (v_1 (_ BitVec 32)) ) 
    (=>
      ...
      (|p$main_4196572::24!slice!2| v_0 v_1)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) ) 
    (=>
      (and
        ...
        (and (= C (bvadd #x00000001 A)) (not (= B #x00000000)))
      )
      (|p$main_4196572::24!slice!2| C B)
    )
  )
)
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) ) 
    (=>
      (and
        ...
        (and (not (bvsle A #x00000032)) (= C (bvadd #xffffffff B)))
      )
...
(assert
  (forall ( (A (_ BitVec 32)) (B (_ BitVec 32)) (C (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196572::24!slice!2| A B)
        (and (bvsle A #x00000032) (= C (bvadd #x00000001 B)))
      )
      (|p$main_4196572::19!slice!1| A C)
    )
  )
...
(assert
  (forall ( (A (_ BitVec 32)) (v_1 (_ BitVec 32)) ) 
    (=>
      (and
        (|p$main_4196572::19!slice!1| A v_1)
        (and (= #x00000000 v_1) (not (= A #x00000065)))
      )
      false
    )
  )
