...
(assert
 (forall ((|p$main_4196032::#_PC_in| (_ BitVec 64)) (|#R31_8!18| (_ BitVec 64)) (|#R0_11!19| (_ BitVec 64)) (|p$main_4196032::#R30_in| (_ BitVec 64)) (|#R30_8!20| (_ BitVec 64)) (|p$main_4196032::#Stack_n8_0| (_ BitVec 64)) (|#R29_8!17| (_ BitVec 64)) (|p$main_4196032::#R0_in| (_ BitVec 64)) (|p$main_4196032::#R1_in| (_ BitVec 64)) (|p$main_4196032::#R1_2| (_ BitVec 64)) (|#Exp18__5_16_1!16| (_ BitVec 64)) (|p$main_4196032::#Stack_n16_n8| (_ BitVec 64)) (|p$main_4196032::#R31_in| (_ BitVec 64)) (|#Exp16__5_15_1!15| (_ BitVec 64)) (|p$main_4196032::#R29_in| (_ BitVec 64)) )(let (($x122 (|p$main_4196032::12| |#R0_11!19| |p$main_4196032::#R0_in| |p$main_4196032::#R1_2| |p$main_4196032::#R1_in| |#R29_8!17| |p$main_4196032::#R29_in| |p$main_4196032::#R30_in| |p$main_4196032::#R31_in| |p$main_4196032::#_PC_in|)))
 (let ((?x110 ((_ extract 31 0) |p$main_4196032::#R1_2|)))
 (let (($x129 (bvsle (_ bv4294957296 32) ?x110)))
 (let (($x130 (|p$main_4196032::23| |p$main_4196032::#R0_in| |p$main_4196032::#R1_2| |p$main_4196032::#R1_in| |p$main_4196032::#R29_in| |p$main_4196032::#R30_in| |p$main_4196032::#R31_in| |p$main_4196032::#Stack_n16_n8| |p$main_4196032::#Stack_n8_0| |p$main_4196032::#_PC_in|)))
 (let (($x131 (and $x130 $x129 (= |#Exp16__5_15_1!15| |p$main_4196032::#Stack_n16_n8|) (= |#Exp18__5_16_1!16| |p$main_4196032::#Stack_n8_0|) (= |#R29_8!17| |#Exp16__5_15_1!15|) (= |#R31_8!18| |p$main_4196032::#R31_in|) (= (_ bv0 64) |#R0_11!19|) (= |#R30_8!20| |#Exp18__5_16_1!16|))))
 (=> $x131 $x122)))))))
 )
(assert
