...
(declare-fun |p$main_4196032::13!slice!1| ( (_ BitVec 64) (_ BitVec 64) ) Bool)
...
(assert
  (forall ( (v_0 (_ BitVec 64)) (v_1 (_ BitVec 64)) ) 
    (=>
      ...
      (|p$main_4196032::13!slice!1| v_0 v_1)
    )
  )
)
(assert
